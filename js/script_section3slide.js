...
$(function () {
    ...
    const visual = $(".section3_slide> li");
    const button = $(".section3_navi_btn_box>li");
    let current = 0; // 현재
    ...
    clearAuto();
    function clearAuto() {
      $(".section3_slide,.section3_navi_btn_box").mouseenter(function () {
        clearInterval(id);
      });
      $(".section3_slide,.section3_navi_btn_box").mouseleave(function () {
        timer();
      });
    }
